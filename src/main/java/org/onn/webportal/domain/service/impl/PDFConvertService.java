...
public class PDFConvertService {
    ...
    public static void main(String[] args) {
    	PDFConvertService fOPPdfDemo = new PDFConvertService();
        try {
    ...
    public void convertToPDF()  throws IOException, FOPException, TransformerException {
        // the XSL FO file
        File xsltFile = new File("export/synthese_export.xsl");
        ...
        // Setup output
        OutputStream out;
        out = new java.io.FileOutputStream("export/temp/synthese.pdf");
