...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
	       ...
	       <ul class="nav navbar-nav">
	        <li class="dropdown">
	          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Gestion d'accès <span class="caret"></span></a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Membre depuis Août. 2016</small>
                </p>
              </li>
              <!-- Menu Footer-->
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="#"><i class="fa fa-location-arrow"></i> <span>Affichage sur carte</span></a></li>
       		<li><a href="#"><i class="fa fa-search"></i> <span>Recherche avancée</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
        	  <li><a href="#"><i class="fa  fa-angle-double-right"></i> <span>Synthèse par région</span></a></li>
      		  <li><a href="#"><i class="fa  fa-angle-double-right"></i> <span>Synthèse par commune</span></a></li>
      		  <li><a href="#"><i class="fa  fa-angle-double-right"></i> <span>Synthèse par fonkotany</span></a></li>     
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2016 <a href="#">Rd Consulting</a>.</strong> Tous droits réservés.
  </footer>
